  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        >
          ...
          <div className="provider-grid">
            <button 
              ...
              aria-label={t('home.provider.google')}
            >
            ...
            <button 
              ...
              aria-label={t('home.provider.discord')}
            >
            ...
            <button 
              ...
              aria-label={t('home.provider.email')}
            >
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
              </svg>
              {t('home.provider.email')}
            </button>
          </div>
          <p className="trust-line">{t('home.provider.modal.footerExtended')}</p>
        </DialogContent>
      </Dialog>
      {/* Sticky CTA - Mobile */}
      {!ctaDismissed && (
      ...
      <Dialog open={showProviderModal} onOpenChange={setShowProviderModal}>
        ...
        >
          <DialogHeader>
            <DialogTitle>{t('home.provider.modal.title')}</DialogTitle>
          </DialogHeader>
